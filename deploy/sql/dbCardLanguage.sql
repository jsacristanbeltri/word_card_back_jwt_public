...
INSERT INTO users (username,password,email,level,experience,log_streak,gems)VALUES('pramos4', '$2a$10$ar82Vt.BK15UZKvBEbqKo.elg1RUK30kqV4KPEF0pYKQ0xf3oVIEW','pramos4@gmail.com',0,0,0,0);
INSERT INTO users (username,password,email,level,experience,log_streak,gems)VALUES('pramos5', '$2a$10$APptla17oJ75u4ndIKopZ.mv9YOMl.X/ZtWYzrGmXwEMvv416DGqK','pramos5@gmail.com',0,0,0,0);
INSERT INTO users (username,password,email,level,experience,log_streak,gems)VALUES('pramos6', '$2a$10$GjoXO11UbM7ndaLwDgpSMOv2ML8/1MynLnVkIV4Nmfgejnp/wpEyG','pramos6@gmail.com',0,0,0,0);
...
insert into decks (name,description,username_id,language_id,number_total_of_cards) 
values ('palabras dificiles spa user 1','todas',2,1,0);
insert into decks (name,description,username_id,language_id,number_total_of_cards) 
values ('palabras dificiles eng user 2','todas',2,2,0);
insert into decks (name,description,username_id,language_id,number_total_of_cards) 
values ('palabras dificiles spa user 1','todas',3,1,0);
insert into decks (name,description,username_id,language_id,number_total_of_cards) 
values ('palabras dificiles eng user 2','todas',3,2,0);
